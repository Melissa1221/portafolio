...
export default function App() {
  ...
  return (
    <section className="relative h-[100dvh] w-full overflow-hidden bg-ink">
      ...
      >
        <div
          className="marquee flex w-max whitespace-nowrap font-display text-[16vh] font-black leading-none text-cookie sm:text-[26vh]"
      ...
      <img
        ...
        alt="Retrato"
        className="anim-rise-in pointer-events-none absolute inset-0 z-20 h-full w-full object-cover object-top"
        style={{ animationDelay: '300ms' }}
      />

      {/* regla horizontal */}
      <div
        className="anim-line absolute inset-x-6 bottom-[5.5rem] z-10 h-0.5 bg-cookie sm:inset-x-10 sm:bottom-28"
      ...
      {/* footer */}
      <footer className="absolute inset-x-0 bottom-0 z-30 flex items-end justify-between px-6 pb-5 font-hn text-xs leading-relaxed text-cookie sm:z-10 sm:px-10 sm:pb-8 sm:text-sm">
